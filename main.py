...
from ollama_interface import OllamaVLMInference, OllamaTextInference
...
def initialize_models():
    ...
    if image_inference is None or text_inference is None:
        model_path = "llava"
        model_path_text = "llama3"

        image_inference = OllamaVLMInference(model=model_path)
        text_inference = OllamaTextInference(model=model_path_text)
        print("**----------------------------------------------**")
